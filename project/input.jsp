<%-- 
    Document   : input
    Created on : Mar 30, 2015, 3:38:31 PM
    Author     : Sherman
--%>
...
<html>
    <head>
        <link href="lib/css/bootstrap/bootstrap.min.css" rel="stylesheet" type="text/css">
				...
				<div class="col-md-12">
					<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Geospatial Project - <span class="step-title">
								Step 1 of 4 </span>
							</div>
									...
									<div class="form-body">
										<ul class="nav nav-pills nav-justified steps">
											<li>
												...
												1 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Import Data</span>
												</a>
											</li>
											<li>
												...
												2 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Set Parameters </span>
												</a>
											</li>
											<li>
												...
												3 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Review Data </span>
												</a>
											</li>
											<li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="form-group">
													<label class="control-label col-md-3">Upload CSV of your delivery locations  <span class="required">
													* </span>
													</label>
													<div class="col-md-4">
														<input type="file" class="form-control" name="password" id="file    "/>
														<span class="help-block">
														Provide your CSV. </span>
													</div>
												</div>
...
<script src="lib/bootstrap-wizard/wizard.js" type="text/javascript"></script>

<script src="lib/js/input.js" type="text/javascript"></script>